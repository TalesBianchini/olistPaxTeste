...
const kPrimaryColor = Color(0xFF304FFE);
...
const String kMatchPassError = "As senhas precisam ser iguais";
const String kNamelNullError = "Por favor insira seu nome";
const String kPhoneNumberNullError = "Por favor insira seu número telefonico";
